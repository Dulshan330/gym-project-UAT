"use client";
import { getUsersForPackageAssign } from "@/app/actions/memberManagement";
import Loader from "@/components/loader";
import AssignPackagePopUp from "@/components/package-assignment/assignPackagePopUp";
...
const PackageSelectionPage = () => {
  ...
  useEffect(() => {
    async function loadUsers() {
      setLoading(true);
      const users = await getUsersForPackageAssign();
      if (users) {
  ...
  const columns: ColumnDef<UsersData>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Popover>
            <AssignPackagePopUp memberId={user.id} />
          </Popover>
        );
      },
    },
    ...
    <div className="p-4 w-full space-y-6 max-h-screen h-full flex flex-col">
      <div className="flex justify-between items-center">
        <div className="space-y-2">
          <p className="text-2xl font-semibold">Package Selection</p>
