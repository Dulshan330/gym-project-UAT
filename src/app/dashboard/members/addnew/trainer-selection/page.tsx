...
import AssignTrainerPopUp from "@/components/trainer-assignment/assignTrainerPopUp";
  ...
  const columns: ColumnDef<UsersData>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <Popover>
            <AssignTrainerPopUp memberId={user.id} />
          </Popover>
        );
      },
    },
    ...
    <div className="p-4 w-full space-y-6 max-h-screen h-full flex flex-col">
      <div className="flex justify-between items-center">
        <div className="space-y-2">
          <p className="text-2xl font-semibold">Trainer Selection</p>
...
export default TrainerSelectionPage;
